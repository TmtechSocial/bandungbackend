        ...
        if (responseCamunda.status === 200 || responseCamunda.status === 204) {
          ...
          const dataQuery = {
            graph: {
              ...
              gqlQuery: `mutation MyMutation($proc_inst_id: String!, $minuman: String!) { update_minum_pedas(where: {proc_inst_id: {_eq: $proc_inst_id}}, _set: {minuman: $minuman }) { affected_rows } }`,
              variables: {
