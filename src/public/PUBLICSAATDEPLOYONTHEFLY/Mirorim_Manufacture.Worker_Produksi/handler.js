  ...
  async onSubmit(data) {
    ...
    for (const item of data) {
      try {
        ...
        const dataCamunda = {
          type: "start",
          endpoint: `/engine-rest/process-definition/b16d9bf6-662c-11f0-9c36-00163e000000/start`,
          variables: {
            variables: {
        ...
        if (responseCamunda.status === 200 || responseCamunda.status === 204) {
          ...
          console.log("id WOrker", item.worker);
...
`,
          ...
          console.log("Full response:", JSON.stringify(responseQuery, null, 2));
          console.log("Sending GraphQL Mutation:", dataQuery.graph.gqlQuery);
          console.log("With Variables:", dataQuery.graph.variables);
