        ...
        if (responseCamunda.status === 200 || responseCamunda.status === 204) {
          ...
          const dataQuery = {
            graph: {
              ...
              gqlQuery: `
            mutation MyMutation($nama_kurir: String!, $submission_date: timestamp!, $file: String!, $user_handover_courier: String!) {
              update_mo_order(
                where: {
                  _and: [
                    { courier_name: { _eq: $nama_kurir } },
