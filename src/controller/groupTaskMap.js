...
module.exports = {
  ...
  "InventoryRejectStaff": ["Mirorim_Operasional.Retur.Placing_Staging_Retur_Reject", "Mirorim_Operasional.Retur.Placement_Item_Retur_Reject", "Mirorim_Stock.Placement_Inbound.Placement_Reject"],
  "Internship": ["Mirorim_Operasional.Order.Scan_Invoice", "Mirorim_Operasional.Order.Picking", "Mirorim_Operasional.Order.Box", "Mirorim_Operasional.Order.Packing", "Mirorim_Warehouse.Internal_Prepare.Processing_Product_Prepare"],
  "InventoryWholesaleD7Staff": ["Mirorim_Warehouse.Internal_Mutasi.Picking_Internal_Mutasi", "Mirorim_Warehouse.Internal_Mutasi.Placement_Internal_Mutasi", "Mirorim_Warehouse.Internal_Mutasi_Prepare.Picking_Mutasi_Prepare", "Mirorim_Warehouse.Generic_Staging.Placement_Staging_Area", "Mirorim_Warehouse.Generic_Mutasi_Prepare.Placement_Mutasi_Prepare", "Mirorim_Stock.Placement_Inbound.Placement_WholesaleD7"],
};
